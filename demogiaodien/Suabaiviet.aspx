<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Suabaiviet.aspx.cs" Inherits="demogiaodien.Suabaiviet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="noidung">
                    ...
                    <br /> <br />
                    <asp:Button ID="btnUpdate" runat="server" Text="Cập Nhật" Height="39px" Width="151px" OnClick="btnUpdate_Click" />
                </div>
</asp:Content>